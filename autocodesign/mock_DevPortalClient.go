...
// CreateProfile provides a mock function with given fields: name, profileType, bundleID, certificateIDs, deviceIDs, templateName
func (_m *MockDevPortalClient) CreateProfile(name string, profileType appstoreconnect.ProfileType, bundleID appstoreconnect.BundleID, certificateIDs []string, deviceIDs []string, templateName string) (Profile, error) {
	ret := _m.Called(name, profileType, bundleID, certificateIDs, deviceIDs, templateName)

	var r0 Profile
	if rf, ok := ret.Get(0).(func(string, appstoreconnect.ProfileType, appstoreconnect.BundleID, []string, []string, string) Profile); ok {
		r0 = rf(name, profileType, bundleID, certificateIDs, deviceIDs, templateName)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, appstoreconnect.ProfileType, appstoreconnect.BundleID, []string, []string, string) error); ok {
		r1 = rf(name, profileType, bundleID, certificateIDs, deviceIDs, templateName)
	} else {
		r1 = ret.Error(1)
	}
